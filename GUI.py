...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.humid_label = customtkinter.CTkLabel(self.sensor_frame, text= "Gray Water Level:", font= customtkinter.CTkFont(size=15, weight='bold'))
        self.humid_label.grid(row=2, column=0, padx=10, pady=10, sticky="w")
        self.humid = customtkinter.CTkLabel(self.sensor_frame, text= "0%", font= customtkinter.CTkFont(size=15, weight='bold'))
        self.humid.grid(row=2, column=1, padx=10, pady=10)
